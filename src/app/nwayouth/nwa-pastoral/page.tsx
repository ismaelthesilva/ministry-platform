        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Over 25 years of faithful ministry, serving God with grateful
              hearts and hopeful spirits
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <Card className="mb-12 p-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm shadow-xl">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            My Christian journey started at the Catholic church in 1999. What
            began as a simple step of faith has blossomed into over 25 years of
            serving God in ministry. When I look back, I&apos;m filled with
            overwhelming gratitude for what God has done in my life. When I look
            forward, I&apos;m filled with hope for the blessings and mercy that
            God has prepared for me and my family.
          </p>
        </Card>
        ...
        <Card className="mb-12 p-8 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 border-indigo-200 dark:border-indigo-700">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            God has chosen me—a simple sinner—for His glory. Through His grace,
            thousands of young people have been discipled and are now serving
            the church in many capacities, some even as pastors. All of this is
        ...
        <Card className="mb-12 p-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm shadow-xl">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            I have been serving God in mission even before my baptism. God has
            given me the privilege to help in various areas such as evangelism,
            youth ministry, preaching, and pastoral care within multicultural
            contexts in both Brazil and New Zealand, alongside my beloved wife,
            Jackie.
          </p>
        ...
        <Card className="mb-12 p-8 bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-teal-900/30 dark:to-cyan-900/30 border-teal-200 dark:border-teal-700">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            My daily work involves encouraging people to have personal communion
            with God, fostering healthy and constructive relationships with
            others, and helping them become involved in the mission of the
            church.
          </p>
        ...
        <Card className="mb-12 p-8 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 border-amber-200 dark:border-amber-700">
          ...
          <div className="bg-white/50 dark:bg-gray-800/50 p-6 rounded-lg">
            ...
            <cite className="text-sm text-gray-500 dark:text-gray-500 mt-4 block">
              Matthew 28:19–20
            </cite>
          </div>
        </Card>
        ...
        <Card className="p-8 bg-gradient-to-r from-slate-50 to-gray-50 dark:from-slate-900/30 dark:to-gray-900/30 border-slate-200 dark:border-slate-700">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            God has blessed me with excellent Tech and Sales experience, which
            proves invaluable in dealing with today&apos;s challenges. This
            background helps me persevere under challenging situations while
            remaining dependent on God to fight the good fight.
          </p>

          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            I maintain a healthy lifestyle, practicing biblical principles, and
            use all the knowledge God gives me to bring hope to all people.
          </p>
