      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mt-4">
            From eFest to youth nights, this term was packed with joy, learning,
            and moments where God&apos;s love shone brightly.
          </p>
          ...
          <Card className="flex flex-col items-center justify-center shadow-lg border-0 bg-white/80 dark:bg-gray-800 col-span-1 sm:col-span-2">
            ...
            <CardContent className="flex flex-col items-center py-4">
              ...
              <div className="mt-2 text-xs text-gray-500 dark:text-gray-400 italic">
                &ldquo;More than medals, we brought home memories, faith, and
                friendship.&rdquo;
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="mb-10 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-gray-800 dark:to-gray-900 border-0 shadow-none">
          <CardContent className="py-8">
            ...
            <p className="mb-4 text-gray-700 dark:text-gray-200">
              What a term it&apos;s been! From the buzz of <b>eFest</b> to our
              Youth Services and challenge games, this past season has been
              packed with joy, learning, and moments where God&apos;s love has
              shone brightly.
            </p>
            <p className="mb-4 text-gray-700 dark:text-gray-200">
              At <b>eFest</b>, our rangatahi played hard, laughed loud, and
              reflected deeply on what Jesus did for us at the cross. We
              didn&apos;t just come home as <b>Fanatics Cup</b> competitors—we
              made it to <b>4 finals</b> (competed in 3, missed 1 for a counting
              error), and God blessed us with{" "}
              <b>2 gold, 1 silver, and 1 bronze</b> medals.
              <br />
              <span className="block mt-2">
                <MedalBadges />
              </span>
              <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 italic">
                More than medals, we returned with hearts full, friendships
                strengthened, and stories of faith written together.
              </span>
            </p>
            <p className="mb-4 text-gray-700 dark:text-gray-200">
              Our series on the <b>Beatitudes</b> helped us learn what it means
              to truly follow Jesus. These weren&apos;t just lessons—they were
              life-shaping truths that our young people are carrying into their
              daily lives.
            </p>
            <p className="mb-4 text-gray-700 dark:text-gray-200">
              Despite the colds and changing weather, youth nights have been
              alive with energy. Most weeks, we&apos;ve welcomed{" "}
              <b>15–20 teens</b>, many bringing new friends along. Out of the{" "}
              <b>60</b> on our list, over
              <b>50</b> have come at least once, and <b>31</b> are attending
              more regularly. That&apos;s something to celebrate!
            </p>
            <p className="mb-4 text-gray-700 dark:text-gray-200">
              We&apos;re also planting seeds to grow our young adults group as
              we navigate the ever-changing rhythms of city life after school.
            </p>
            <p className="mb-4 text-gray-700 dark:text-gray-200">
              Our heart remains simple: to have fun, build real relationships,
              and grow in God&apos;s grace. We&apos;re always encouraging our
              youth to be part of this journey—to come, serve, and invite others
              to follow Jesus.
            </p>
            <p className="mb-4 text-gray-700 dark:text-gray-200">
            ...
            <div className="mt-6 text-right">
              ...
              <span className="block text-xs text-gray-500 dark:text-gray-400 mt-2 italic">
                &ldquo;May the Lord continue to guide, protect, and inspire our
                youth as they shine for Him.&rdquo;
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="text-center mt-8">
          <Link href="/anglican/nwayouth">
            <Button
              size="lg"
              className="bg-gradient-to-r from-pink-500 to-purple-600 text-white shadow-lg hover:from-pink-600 hover:to-purple-700"
            >
              Back to NWAY Youth
            </Button>
          </Link>
