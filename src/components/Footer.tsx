          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Professional fitness coaching and personalized nutrition
                guidance to help you achieve sustainable health transformations.
                Serving clients across Brazil, USA, and New Zealand with
              ...
              <div className="flex flex-wrap gap-2">
                ...
                >
                  <Globe className="h-3 w-3 mr-1" />3 Countries
                </Badge>
              </div>
            </div>
            {/* Contact Info */}
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-muted-foreground">
                ...
                <a
                  href="mailto:contact@drjackie.com"
      ...
      <div className="container mx-auto px-6 py-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-muted-foreground">
            ...
            <Heart className="h-4 w-4 inline text-red-500" /> for your health
            journey.
          </div>
