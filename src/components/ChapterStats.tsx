...
const ChapterStats: React.FC<ChapterStatsProps> = ({
  ...
  const scriptureReadingTime = Math.ceil(
    scriptureWordCount / AVERAGE_READING_SPEED
  );
  const commentaryReadingTime = Math.ceil(
    commentaryWordCount / STUDY_READING_SPEED
  );
  ...
  const commentaryRatio = Math.round(
    (commentaryWordCount / scriptureWordCount) * 100
  );
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1 text-xs text-gray-600 dark:text-gray-400">
            <div className="flex justify-between">
              ...
              <span>
                {formatTime(
                  Math.ceil(totalWords / (AVERAGE_READING_SPEED * 1.5))
                )}
              </span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <span>
                {formatTime(
                  Math.ceil(totalWords / (STUDY_READING_SPEED * 0.6))
                )}
              </span>
            </div>
          </div>
