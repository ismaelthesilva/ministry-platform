...
const navLinks = [
  ...
  { label: "Pastoral", to: "/nwayouth/nwa-pastoral" },
  { label: "Reports", to: "/nwayouth/nwa-report-term2" },
  { label: "Resources", to: "/nwayouth/nwa-resources" },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-200 via-purple-100 to-pink-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col items-center py-8">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-4 max-w-xl mx-auto">
          Where faith, fun, and friendship meet! Join us for worship, real talk,
          and unforgettable moments.
        </p>
        <Badge className="bg-pink-500 text-white text-base px-4 py-2 mb-2">
          #ShineBright
        </Badge>
        <div className="mt-4">
          <Button
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        {moreVideos.map((video, idx) => (
          <Card
            key={idx}
            className="shadow-md border-2 border-purple-200 dark:border-purple-700"
          >
            <CardHeader>
      ...
      <div className="text-center mt-8 mb-16">
        ...
        <p className="text-gray-700 dark:text-gray-300 max-w-xl mx-auto mb-4">
          NWA Youth is a community where you belong. Bring your friends, share
          your story, and discover your purpose in Christ. We can&apos;t wait to
          meet you!
        </p>
        <Button
          variant="outline"
          className="border-pink-400 text-pink-600 hover:bg-pink-50 dark:hover:bg-pink-900"
        >
