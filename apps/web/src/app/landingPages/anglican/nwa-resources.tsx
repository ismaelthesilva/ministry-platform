...
const NWAResourcesPage = () => {
  const resources = [
    ...
    },
    {
      ...
      description:
        "C.S. Lewis Study Guide - Deep dive into Christian fundamentals",
    ...
    },
    {
      title: "Instagram",
      description:
        "@northwestanglican_youth - Follow for updates and inspiration",
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-indigo-900 dark:to-purple-900 relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed mb-8 opacity-0 animate-[fadeInUp_0.8s_ease-out_0.3s_forwards]">
              Your one-stop hub for all ministry resources, study guides, and
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          ...
          <Badge
            variant="outline"
            className="px-4 py-2 text-sm font-medium hover:bg-orange-50 hover:border-orange-300 transition-colors"
          >
          ...
          <Badge
            variant="outline"
            className="px-4 py-2 text-sm font-medium hover:bg-green-50 hover:border-green-300 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {resources.map((resource, index) => (
            ...
            >
              <div
                className={`${resource.color} ${resource.hoverColor} transition-all duration-500 p-6 relative overflow-hidden`}
              >
                {/* Background pattern */}
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <Badge
                          variant="secondary"
                          className="bg-white/25 text-white border-white/40 backdrop-blur-sm hover:bg-white/35 transition-colors duration-300 mt-1"
                        >
                          {resource.type}
                        </Badge>
                      </div>
          ...
          <Card className="p-10 bg-gradient-to-br from-white/90 to-white/70 dark:from-gray-800/90 dark:to-gray-800/70 backdrop-blur-lg border-0 shadow-2xl">
            <CardHeader className="text-center p-0 mb-8">
              ...
              <CardDescription className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto">
                Join our vibrant youth community and stay connected with all our
                activities, resources, and fellowship opportunities. Together,
                we grow in faith and friendship.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="p-0">
              <div className="flex flex-wrap justify-center gap-4">
                <Badge
                  variant="outline"
                  className="px-6 py-3 text-base hover:bg-indigo-50 hover:border-indigo-300 transition-colors duration-300"
                >
                  <BookOpen className="h-4 w-4 mr-2" />
                  Youth Ministry
                </Badge>
                <Badge
                  variant="outline"
                  className="px-6 py-3 text-base hover:bg-purple-50 hover:border-purple-300 transition-colors duration-300"
                >
                  <Users className="h-4 w-4 mr-2" />
                  Young Adults
                </Badge>
                <Badge
                  variant="outline"
                  className="px-6 py-3 text-base hover:bg-pink-50 hover:border-pink-300 transition-colors duration-300"
                >
                ...
                <Badge
                  variant="outline"
                  className="px-6 py-3 text-base hover:bg-blue-50 hover:border-blue-300 transition-colors duration-300"
                >
                  <Star className="h-4 w-4 mr-2" />
                  Fellowship
                </Badge>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-blue-200 dark:border-blue-700">
            ...
            <CardContent>
              <CardDescription className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                Save this page to your home screen for instant access to all
                resources and group links. Never miss an update or important
                document again.
              </CardDescription>
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 hover:scale-105 border-purple-200 dark:border-purple-700">
            ...
            <CardContent>
              <CardDescription className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                Help other youth members stay connected by sharing this
                resources hub. Building community starts with staying connected.
              </CardDescription>
